# udp_stress_client.py by Atila Xavier
...
parser = argparse.ArgumentParser(description='udp_stress_client.py. UDP packets generator client.')
...
while True:
	...
	if not data:
		...
		try:
			#the resetter...
			#UDPSock.sendto(bytes('X', 'utf-8'), (host,port))
			# sending numer of bursts and size of each burst in the format: #<numbytes>#<numtimes>
